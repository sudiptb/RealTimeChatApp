...
import com.plcoding.streamchatapp.util.navigateSafety
                ...
                when (event) {
                    is LoginViewModel.LoginEvent.ErrorInputTooShort -> {
                        ...
                        binding.etUsername.error =
                            getString(R.string.error_username_too_short, MIN_USERNAME_LENGTH)
                    }
                    ...
                    is LoginViewModel.LoginEvent.Success -> {
                        setUpIdleUiState()
                        findNavController().navigateSafety(R.id.action_loginFragment_to_channelFragment)
                    }
                }
            }
        }
